...
async def start(bot, message):
    await message.reply(
        ...
        "**Send me a  Long Url or Directly Forward me a Post to See the ✨ Magic**\n\n"
        "__Coded by @Shashwat_Bhai__")
...
async def remove_username(new_List):
    for i in new_List:
        if('@' in i):
            new_List.remove(i)
        if('t.me' in i or 'https://bit.ly/abcd' in i or 'https://bit.ly/123abcd' in i or 'telegra.ph' in i): 
            new_List[i] = 'Ishan'
    return new_List
